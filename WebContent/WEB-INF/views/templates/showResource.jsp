  ...
  <form:form modelAttribute="resource" id="form" action="${actionUrl}">
    ...
    <c:if test="${!empty resource}">
      ...
      <table id="datatable" class="table display">
        <tr>
          <td><spring:message code="label.resource.description" />
            :</td>
        ...
        <tr>
          <td colspan="2"><span id="geoCoords"> <span
              ...
              style="display: none;"></span> <spring:message
                code="label.resource.coordinates" />: <c:if
                test="${allUrkaine}">
                ...
                <div class="col-sm-12 polygon">
                  <c:forEach var="point" items="${poligon.points}">
                    <div class="coordinatesPoint">
                      <span class="pointLat"> <span
                        class="latitudeDegrees">${point.latitudeDegrees}</span>°
        ...
        <c:forEach var="discrete" items="${resource.resourceDiscrete}">
          <tr>
            ...
            <c:forEach var="valueDiscrete"
              items="${discrete.valueDiscretes}">
              <td><span class="col-sm-6">${valueDiscrete.value}</span>
                <span class="col-sm-6">${valueDiscrete.comment}</span></td>
            </c:forEach>
          </tr>
        </c:forEach>
      </table>
      ...
      <div class="form-group">
        <div class="col-sm-5">
          <sec:authorize access="hasRole('USER')">
            <div id="outputInquiry" class="btn btn-success"
        ...
        <div class="col-sm-5">
          <sec:authorize access="hasRole('REGISTRATOR')">
            ...
            <div id="deleteResource" class="btn btn-danger"
              role="button" style="margin-bottom: 10px">
