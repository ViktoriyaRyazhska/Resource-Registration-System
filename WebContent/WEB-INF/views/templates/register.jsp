  ...
  <form:form id="registrationForm" action="" class="form-horizontal" role="form"
    ...
    <div class="form-group col-sm-12">
      <div class="personal_header col-lg-4">
        ...
        <div class="col-lg-8">
          <input name="firstName" type="text" class="form-control login"
            ...
            required />
          <form:errors path="firstName" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="lastName" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          <input name="middleName" type="text"
            class="form-control login" id="middleName"
            value="${registrationForm.middleName}" />
          <form:errors path="middleName" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="email" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="login" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          <input name="password" type="password"
            class="form-control login" id="password" type="password"
            required />
        ...
        <div class="col-lg-8">
          <input name="confirmPassword" type="password"
            class="form-control login" id="confirmPassword"
      ...
      <div class="address_header col-lg-4">
        ...
        <div class="col-lg-8">
          <input name="address.city" type="text"
            class="form-control login" id="city"
            value="${registrationForm.address.city}" />
          <form:errors path="address.city" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          <input name="address.region" type="text"
            class="form-control login" id="region"
            value="${registrationForm.address.region}" />
          <form:errors path="address.region" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="address.district" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          <input name="address.street" type="text"
            class="form-control login" id="street"
            value="${registrationForm.address.street}" />
          <form:errors path="address.street" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="address.building" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          <input name="address.flat" type="text"
            class="form-control login" id="flat"
            value="${registrationForm.address.flat}" />
          <form:errors path="address.flat" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="address.postcode" class="error" cssStyle="color:red"/>
          <br>
        </div>
      </div>
      <div class="passport_header col-lg-4">
        ...
        <div class="col-lg-8">
          <input name="passport.seria" type="text"
            class="form-control login" id="passport_seria"
            value="${registrationForm.passport.seria}" />
          <form:errors path="passport.seria" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="passport.number" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="passport.published_by_data" class="error" cssStyle="color:red"/>
          <br>
        </div>
        <h4>
        ...
        <div class="col-lg-8">
          <input name="phoneNumber" type="text"
            class="form-control login" id="phone_number"
            value="${registrationForm.phoneNumber}"
            placeholder="<spring:message
						code="label.manualregister.phoneexample" />" />
          <form:errors path="phoneNumber" class="error" cssStyle="color:red"/>
          <br>
        </div>
        <label class="col-lg-4 control-label"
          for="territorial_Community"><spring:message
        ...
        <div class="col-lg-8">
          ...
          <form:errors path="territorialCommunity" class="error" cssStyle="color:red"/>
          <br>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="control-group error">
            <form:errors path="dateOfAccession" class="error" cssStyle="color:red"/>
            <br>
          </div>
        </div>
      </div>
