...
<div class="container">
  ...
  <form:form id="addResource" method="POST" modelAttribute="resource"
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
        <input class="form-control" name="description"
          id="w-input-search" value="${resource.description}">
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
        <select id="resourcesTypeSelect" name="resourceType"
          ...
          <c:set var="actualResourceType"
            value="${resource.resourceType}" scope="page" />
          <c:if test="${empty resource.resourceType}">
    ...
    <div class="form-group">
      ...
      <div class="checkbox">
        <div class="col-md-3">
          <label><input class="disable" id="pass"
            type="checkbox" disabled> <spring:message
              code="label.resource.pass" /></label><br /> <label><input
            class="disable" id="will" type="checkbox" disabled>
            <spring:message code="label.resource.willDocument" /></label><br />
          <label><input class="disable" id="otherDocs"
            type="checkbox" disabled> <spring:message
              code="label.resource.otherDocuments" /></label><br /> <label><input
            class="disable" id="tytul" type="checkbox" disabled>
            <spring:message code="label.resource.propertyTitle" /></label><br />
          <label><input id="delivery" type="checkbox"> <spring:message
      ...
      <div class="tab-pane" id="points">
        <div id="latLngAdd"
          ...
          <c:if test="${firstPoint != 0}">
            <c:forEach items="${resource.resourceArea.poligons}"
              var="polygon" varStatus="polygonStatus">
              ...
              <div id="polygon_${polygonIndex+1}">
                ...
                <c:forEach items="${polygon.points}" var="point"
                  ...
                  <c:set value="${pointStatus.count -1}"
                    var="pointIndex" />
                  <div id="areaInput1"
                    class="form-group clonedAreaInput">
                    <div class="col-md-1"
                    ...
                    <div class="col-md-1">
                      <a
                        class="delPoint glyphicon glyphicon-remove-sign"></a>
                    </div>
                  </div>
                </c:forEach>
              </div>
          ...
          <div id="mybuttontype">
            <button id="addPointsToMap" class="btn btn-primary"
              type="button">
              <spring:message code="label.resource.coordinates.addToMap" />
            </button>
            <button class="btn btn-primary" id="btnAddAreaPoint"
              type="button">
              <spring:message code="label.resource.coordinates.addPoint" />
            </button>
            <button class="btn btn-primary" id="addPolygon"
              type="button">
              <spring:message
                code="label.resource.coordinates.addPolygon" />
            </button>
            <%--<input type="button"--%>
            <%--id="btnDelAreaPoint" value="-"--%>
            <%--class="btn btn-primary deleteButton"/>--%>
            <button class="btn btn-danger" id="clearAllPoints"
              type="button">
              <spring:message code="label.resource.coordinates.clearAll" />
            </button>
            <button class="btn btn-danger" id="delAllPolygons"
              type="button">
              <spring:message
                code="label.resource.coordinates.delAllPolygons" />
            </button>
          </div>
          <br />
        </div>
