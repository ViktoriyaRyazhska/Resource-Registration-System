...
<div class="change_password_container">
  <fieldset id="change_password_fieldset">
    ...
    <c:if test="${msg == null}">
      <form:form class="form-horizontal" name='passwordChangeDTO'
        id="passwordChangeDTO" modelAttribute="passwordChangeDTO"
        action="${pageContext.request.contextPath}/change_password"
        method='POST'>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <button id="update" name="update" class="btn btn-success">
              <spring:message code="label.updatePassword" />
            </button>
            <button id="cancel" name="cancel" class="btn btn-danger"
              formnovalidate="true">
              <spring:message code="label.cancelPolygon" />
            </button>
          </div>
        </div>
