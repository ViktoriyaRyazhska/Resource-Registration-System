...
function intersectionCheck() {
  ...
  var intersection = checkIntersectionAllPolygons(activePolygon, newPolygons) || checkIntersectionAllPolygons(activePolygon, polygons);
...
function calculateAreaPerimeter(polygon, i) {
  ...
  //Generate html
  return "<div>" + "<label>" + jQuery.i18n.prop('msg.Polygon') + " " + (i + 1) + ": </label> " + "<span>" + jQuery.i18n.prop('msg.Area') + " " + (area).toFixed(5) + " " + jQuery.i18n.prop('msg.Area.units') + "; </span>" + "<span>"
